sap.ui.define([
    ...
    return Controller.extend("app.miningproject.controller.MiningView", {
        ...
        onSort: function () {
            ...
            var oSorter = new Sorter("Location Description", this.bDescending);
        ...
        onSearch: function (oEvent) {
            ...
            var oName = new Filter("Location Description", FilterOperator.Contains, searchString);
            var oID = new Filter("Location ID", FilterOperator.Contains, searchString);
